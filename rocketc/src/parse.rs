//! Parsing module for Rocket source files.
//!
//! Uses tree-sitter-rocket to parse .rocket files and convert
...
use tree_sitter_rocket::LANGUAGE;

use crate::diagnostics::{CheckResult, Diagnostic, Location, Suggestion};

/// Parse a Rocket source file and return check results.
pub fn parse_file(path: &Path) -> Result<CheckResult, std::io::Error> {
    ...
    parser
        ...
        .expect("Failed to load Rocket grammar");
