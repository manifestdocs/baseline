...
module.exports = grammar({
  ...
  rules: {
    ...
    match_arm: $ => seq($._pattern, repeat(seq('|', $._pattern)), optional($.match_guard), '->', $._expression),
    ...
    wildcard_pattern: $ => '_',
    record_pattern: $ => seq('{', commaSep(choice($.record_rest_pattern, $.record_pattern_field)), '}'),
    record_rest_pattern: $ => '..',
