<section class="hero" aria-labelledby="hero-heading">
	...
	<div class="hero-split">
		<div class="hero-left">
			<p class="hero-subtitle">Simple syntax. Fast runtime. Catches mistakes. Baseline is easy to learn and hard to break, whether you're writing the code yourself, with your team, or an AI agent.</p>
			<ul class="hero-pillars">
				<li class="hero-pillar">
					<em>Simple to learn</em>
					<span>Small, consistent syntax that reads the same everywhere</span>
				</li>
				<li class="hero-pillar">
				...
				<li class="hero-pillar">
					...
					<span>The compiler checks types, effects, and error handling before your code runs</span>
				</li>
			</ul>
		</div>
  ...
  <span class="kw">match</span> <span class="fn">response</span><span class="punct">.</span><span class="fn">status</span>
    ...
    <span class="fn">code</span> <span class="op">-&gt;</span> <span class="type">Err</span><span class="punct">(</span><span class="str">"HTTP \${code}"</span><span class="punct">)</span>`}</code></pre>
			<div class="btn-group" style="margin-top: var(--sp-4);">
				...
				<a href="https://github.com/manifestdocs/baseline" class="button">View on GitHub</a>
			</div>
		</div>
	</div>
</section>
